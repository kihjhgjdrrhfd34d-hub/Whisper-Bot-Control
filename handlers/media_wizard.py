...
FOUR_OPTIONS = [
    ...
    ("first_five",  5, "همسة لأول خمسة أشخاص",   "👥 يقرأها أول 5 أشخاص فقط", "هذه همسه سريه لاول خمسة أشخاص يقومون بقرأتها"),
...
DESTRUCTIVE_OPTIONS = [
    ...
    ("first_five",  5, "💣 همسة تدميرية لـ 5 أشخاص",    "💥 تُحذف بعد خامس قارئ",    "💣 همسة تدميرية لـ 5 أشخاص"),
